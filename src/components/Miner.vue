...
<template>
    <main>
        ...
        <div class="coin-container numbers-container" ref="numbersContainerRef">
            <img v-if="userStore.user?.is_premium" src="@/assets/images/coin.svg" alt="Premium Coin" class="coin" ref="coinRef" @mousedown="applyTilt" @touchstart="applyTilt"
                @mouseup="resetTilt" @mouseleave="resetTilt" @touchend="resetTilt" />
            <img v-else src="@/assets/images/coin.svg" class="coin" alt="Regular Coin" ref="coinRef" @mousedown="applyTilt" @touchstart="applyTilt"
                @mouseup="resetTilt" @mouseleave="resetTilt" @touchend="resetTilt" />
        </div>
    </main>
    <BottomMenu />
